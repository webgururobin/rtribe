    ...
    return (
        <form onSubmit={formAction} className='flex max-sm:w-full max-w-screen-sm  px-2 z-10 relative'>
            <div className='flex-1 border-orange border-b-0'>
                <span className='text-[#F05A28] font-nippo font-normal text-left block border-orange border-[1px] border-b-0 text-sm md:text-[20px] uppercase md:tracking-[10px] tracking-[6px] px-4 py-2'>Join the Tribe</span>
                <Input
